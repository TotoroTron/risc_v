...
## RGB LEDs
# set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { led[8] }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
# set_property -dict { PACKAGE_PIN G14    IOSTANDARD LVCMOS33 } [get_ports { led[9] }]; #IO_0_35 Sch=LED5_B
# set_property -dict { PACKAGE_PIN L14    IOSTANDARD LVCMOS33 } [get_ports { led[5] }]; #IO_L22P_T3_AD7P_35 Sch=LED5_G
# set_property -dict { PACKAGE_PIN M15    IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L23N_T3_35 Sch=LED5_R

# R
set_property PACKAGE_PIN N15 [get_ports led[0]]
set_property PACKAGE_PIN M15 [get_ports led[1]]
# G
# set_property LOC G17 [get_ports rgb_g0]
# set_property LOC L14 [get_ports rgb_g1]
# B
# set_property LOC L15 [get_ports rgb_b0]
# set_property LOC G14 [get_ports rgb_b1]]
